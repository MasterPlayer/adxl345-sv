...
int main() {
    ...
    cfg.ctl_reg = 0x0201D300;
    cfg.request_interval_reg = 0x00001000;
    cfg.calibration_count_reg = 0x00000004;
    cfg.read_valid_count_reg = 0x9F000000;
    cfg.write_valid_count_reg = 0x8F000000;
    cfg.read_transactions_lsb_reg = 0x00000000;
    cfg.read_transactions_msb_reg = 0x00000001;
    cfg.clk_period_reg = 20000000;
    cfg.opt_request_interval_lsb_reg = 0x00000000;
    cfg.opt_request_interval_msb_reg = 0x00000001;
    cfg.data_width_reg = 0x00000008;
    cfg.calibration_time_lsb_reg = 0x00000000;
    cfg.calibration_time_msb_reg = 0x00000001;
    cfg.write_transactions_lsb_reg = 0x00000000;
    cfg.write_transactions_msb_reg = 0x00000001;
    cfg.single_req_params_reg = 0x00000000;
