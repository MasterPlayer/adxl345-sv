...
#define BW_RATE_LOW POWER_MASK          0x10 //000X1010   LOW POWER
...
//0x00
#define adxl_get_device_id(ptr) ((ptr)->device_id_reg)
//0x1d
#define adxl_set_thresh_tap(ptr, value) ((ptr)->thresh_tap_reg = (uint8_t)value)
#define adxl_get_thresh_tap(ptr) ((ptr)->thresh_tap) (ptr)->thresh_tap_reg
//0x1e
#define adxl_set_ofsx(ptr, value) ((ptr)->ofsx_reg = (uint8_t)value)
#define adxl_get_ofsx(ptr) ((ptr)->ofsx_reg)
//0x1f
#define adxl_set_ofsy(ptr, value) ((ptr)->ofsy_reg = (uint8_t)value)
#define adxl_get_ofsy(ptr) ((ptr)->ofsy_reg)
//0x20
#define adxl_set_ofsz(ptr, value) ((ptr)->ofsz_reg = (uint8_t)value)
#define adxl_get_ofsz(ptr) ((ptr)->ofsz_reg)
//0x21
#define adxl_set_dur(ptr, value) ((ptr)->dur_reg = value)
#define adxl_get_dur(ptr) ((ptr)->dur_reg)

#define adxl_set_latent(ptr, value) ((ptr)->latent_reg = value)
#define adxl_get_latent(ptr) ((ptr)->latent_reg)

#define adxl_set_window(ptr, value) ((ptr)->window_reg = value)
#define adxl_get_window(ptr) ((ptr)->window_reg)

#define adxl_set_thresh_act(ptr, value) ((ptr)->thresh_act_reg = value)
#define adxl_get_thresh_act(ptr) ((ptr)->thresh_act_reg)

#define adxl_set_thresh_inact(ptr, value) ((ptr)->thresh_inact_reg = value)
#define adxl_get_thresh_inact(ptr) ((ptr)->thresh_inact_reg)



#define adxl_set_act_inact_ctl(ptr, value) ((ptr)->act_inact_ctl_reg = value)
#define adxl_get_act_inact_ctl(ptr, value) ((ptr)->act_inact_ctl_reg)

#define adxl_set_thresh_ff(ptr, value) ((ptr)->thresh_ff_reg = value)
#define adxl_get_thresh_ff(ptr) ((ptr)->thresh_ff_reg)

#define adxl_set_time_ff(ptr, value) ((ptr)->time_ff_reg = value)
#define adxl_get_time_ff(ptr) ((ptr)->time_ff_reg)


#define adxl_set_tap_axes(ptr, value) ((ptr)->tap_axes_reg = value)
#define adxl_get_tap_axes(ptr) ((ptr)->tap_axes_reg)


#define adxl_get_act_tap_status(ptr) ((ptr)->act_tap_status_reg)




#define adxl_set_bw_rate(ptr, value) ((ptr)->bw_rate_reg = (uint8_t)value)
#define adxl_get_bw_rate(ptr) ((ptr)->bw_rate_reg)



#define adxl_set_power_ctl(ptr, value) ((ptr)->power_ctl_reg = (uint8_t)value)
#define adxl_get_power_ctl(ptr) ((ptr)->power_ctl_reg)


#define adxl_set_int_enable(ptr, value) ((ptr)->int_enable_reg = value)
#define adxl_get_int_enable(ptr) ((ptr)->int_enable_reg)


#define adxl_set_int_map(ptr, value) ((ptr)->int_map_reg = value)
#define adxl_get_int_map(ptr) ((ptr)->int_map_reg)


#define adxl_get_int_source(ptr) ((ptr)->int_source_reg)


#define adxl_set_data_format(ptr, value) ((ptr)->data_format_reg = (uint8_t)value)
#define adxl_get_data_format(ptr) ((ptr)->data_format_reg)

#define adxl_get_datax0(ptr) ((ptr)->datax0_reg)
#define adxl_get_datax1(ptr) ((ptr)->datax1_reg)
#define adxl_get_datay0(ptr) ((ptr)->datay0_reg)
#define adxl_get_datay1(ptr) ((ptr)->datay1_reg)
#define adxl_get_dataz0(ptr) ((ptr)->dataz0_reg)
#define adxl_get_dataz1(ptr) ((ptr)->dataz1_reg)


#define adxl_set_fifo_ctl(ptr, value) ((ptr)->fifo_ctl_reg = value)
#define adxl_get_fifo_ctl(ptr) ((ptr)->fifo_ctl_reg)

#define adxl_get_fifo_status(ptr) ((ptr)->fifo_status_reg)
